            ...
            <div class="grid w-full grid-cols-1 gap-4 md:grid-cols-3">
                <div class="w-full">
                    <a href="https://t.me/masteritsystems_saleconsultant" target="_blank" class="w-full">
                        <button
                            class="flex items-center w-full gap-2 p-4 text-white rounded-md shadow-lg bg-background hover:bg-background/90">
                            ...
                            <span class="font-bold text-lg smd:text-sm md:text-[14px] lg:text-md xl:text-lg">{{ $t('telegram') }}</span>
                        </button>
                    </a>
                </div>
                ...
                <div class="w-full">
                    <router-link to="/" class="w-full">
                        <button
                            ...
                            <span class="font-bold text-lg smd:text-sm md:text-[14px] lg:text-md xl:text-lg">{{ $t('consultantForStudy') }}</span>
                        </button>
                    </router-link>
                </div>
                ...
                <div class="w-full">
                    <router-link to="/" class="w-full">
                        <button
                            ...
                            <span class="font-bold text-lg smd:text-sm md:text-[14px] lg:text-md xl:text-lg">{{ $t('phoneNumber') }}</span>
                        </button>
                    </router-link>
                </div>
            </div>
