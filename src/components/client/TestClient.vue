      ...
      <div v-for="cat in productDetails" :key="cat.id" class="mb-5">
        <div v-for="pro in cat.product" :key="pro.id" class="mb-2">
          ...
          <p class="text-[14px] md:text-[16px] lg:text-[15px] text-color_text mt-2">{{ pro.productName }}
            relates to <span class="text-indigo-600 cursor-pointer font-bold hover:text-indigo-800">Development,</span>
          ...
          <div class="w-full relative mt-4 hidden md:block">
            <TabGroup>
              <TabList class="flex space-x-5  p-1">
                <Tab v-for="(category, idx) in categories" :key="idx" as="template" v-slot="{ selected }">
                  <button :class="[
              ...
              <TabPanels class="mt-3">
                <TabPanel v-for="category in productDetails" :key="category.id" class="relative select-none">
                  <div v-for="product in category.product" :key="product.id">
                    <swiper ref="mySwiper" :navigation="{
                      nextEl: '.button-next-slide',
                      prevEl: '.button-pre-slide'
                    }" :loop="false" :modules="modules" :allowTouchMove="true" :slides-per-group="3" :speed="1000"
                      :breakpoints="{
                        '540': {
                          slidesPerView: 2,
                          spaceBetween: 15,
                      ...
                      }" class="mySwiper relative xl:w-[1200px]" @reachEnd="showNextButton = false"
                      ...
                      <swiper-slide
                        ...
                        <div class="border-[1px]">
                          <img :src="detail.imageUrl" alt="" class="w-full h-40 object-contain" />

                        </div>
                        <div class="mt-2 space-y-1">
                          <p class="text-[14px] font-semibold line-clamp-2 cursor-pointer"> {{ detail.title }}</p>
          ...
          <div class="md:hidden">
            <div>
              ...
              <div @click="handleIsOpenDropdownProduct('Most Popular')" :class="{
                ...
                <svg
                  :class="!isOpenDropdownProduct ? ' transition-all duration-300 ease-in-out' : '-rotate-180 transition-all duration-300 ease-in-out'"
                    ...
                    <div v-for="product in category.product" :key="product.id">
                      <swiper ref="mySwiper" :navigation="{
                        ...
                        <swiper-slide
                          ...
                          :key="detail.id">
                          <div class="border-[1px]">
                            <img :src="detail.imageUrl" alt="" class="w-full h-48 object-cover" />

                          </div>
                          <div class="mt-2 space-y-1">
                            <p class="text-[15px] font-semibold line-clamp-2 cursor-pointer"> {{ detail.title }}</p>
                            <p class="text-gray-500 text-[12px] line-clamp-1">{{ detail.lectures }}</p>
                            <div class="flex space-x-[2px] items-center">
          ...
          <div class="md:hidden">
            <div>
              ...
              <div @click="handleIsOpenDropdownNew('New')" :class="{
                ...
                <svg
                  :class="!isOpentDrodownNewLession ? ' transition-all duration-300 ease-in-out' : '-rotate-180 transition-all duration-300 ease-in-out'"
                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="size-4">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            ...
            <div class="md:hidden">
              <div>
                ...
                <div @click="handleIsOpenDropdownBeginer('Beginer Favorites')" :class="{
                  ...
                  <svg
                    :class="!isOpenDropdownFavorite ? ' transition-all duration-300 ease-in-out' : '-rotate-180 transition-all duration-300 ease-in-out'"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                  </svg>
